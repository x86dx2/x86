...
answer = "O Dataset não é composto somente de male+female rodando o comando print(set(column_to_list(data_list, -2))) pegamos os valores unicos dessa feature e pude encontrar campos vazios, por esse motivo a condição é falsa."
...
"""
    Argumentos:
      param1: lista de colunas.
      Retorna:
       tipo_de_itens, contagem.
"""
